...
<head>
 <meta charset="utf-8">
  <meta content="width=device-width, initial-scale=1.0" name="viewport">
   ...
   <title>Register Akun Pelayanan IT STIKES DHB</title>
       ...
       <div class="d-flex justify-content-center py-4">
        ...
        <div class="card mb-3">
         <div class="card-body">
          ...
          <form method="post" action="/user_register" class="row g-3 needs-validation" novalidate>
          @csrf
           <div class="col-12">
              ...
              <label for="yourPassword" class="form-label">Password</label>
               <div class="input-group" id="show_hide_password">
                ...
                <div class="invalid-feedback">Please enter your password!</div>
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit"><a href="berhasil_register"></a>Create Account</button>
                    </div>
