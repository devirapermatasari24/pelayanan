...
<!-----keluhan software---->
    <div class="col-lg-12">
     ...
     <div class="card">
      <div class="card-body">
       <h5 class="card-title">FORM PERTANYAAN KE BAG HUMAS</h5>

<!-- End Keluhan software -->

<!-- NIM NIK-->
        <form method="post" action="/simpankelsoftware" >
        @csrf
        <div class="form-row">
         <div class="row mb-3">
...
<!--------di kerjakan oleh-->
 ...
 <!----- Tanggal di kerjakan----->
            <div class="row mb-3">
             <label for="inputEmail3" class="col-sm-2 col-form-label">Tanggal Input</label>
              <div class="col-sm-2">
